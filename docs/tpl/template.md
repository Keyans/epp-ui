...
<img src="../.vuepress/public/img/test.png">
<!-- <demo-block>
  <template-detailTpl-base-form slot="source"></template-detailTpl-base-form>
  <<< @/docs/.vuepress/components/template/detailTpl/base-detail.vue
</demo-block> -->
